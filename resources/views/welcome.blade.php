...
@section('content')
    ...
    <p class="fw-bold">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Velit eius deleniti commodi rerum minima tempora iusto ipsam, quisquam animi assumenda?</p>
            </div>
        </div>
    </div>
@endsection